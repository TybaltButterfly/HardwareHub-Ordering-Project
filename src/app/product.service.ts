...
export interface Product {
  ...
  // Added for flash sales local relevance
...
export class ProductService {
  private productsSubject: BehaviorSubject<Product[]> = new BehaviorSubject<Product[]>([
    ...
    { id: 4, name: 'Cordless Impact Driver', description: 'High torque cordless impact driver', price: 229.99, category: 'power-tools', image: 'assets/cordless-impact-driver.webp', stock: 5, status: true },
    { id: 5, name: 'Measuring Tape', description: '25-foot retractable measuring tape', price: 50.99, category: 'hand-tools', image: 'assets/measuring-tape.avif', stock: 0, status: false },
